...
export const pagesByRole: Record<Role, PageMeta[]> = {
  student: [
    ...
    { id: 'directory', label: 'Explore', description: 'Search', icon: 'search' },
  ...
  employer: [
    ...
    { id: 'directory', label: 'Talent', description: 'Search', icon: 'search' },
    { id: 'inbox', label: 'Messages', description: 'Chat', icon: 'mail' },
    { id: 'notifications', label: 'Notifications', description: 'Alerts', icon: 'bell' },
  ],
  instructor: [
    ...
    { id: 'directory', label: 'Browse', description: 'Search', icon: 'search' },
    { id: 'inbox', label: 'Messages', description: 'Chat', icon: 'mail' },
    { id: 'notifications', label: 'Notifications', description: 'Alerts', icon: 'bell' },
  ],
  admin: [
